				...
				<div id="myCarousel" class="carousel slide ">
					...
					<div class="carousel-inner">
						<div class="item active">
							...
							<div class="carousel-caption"><h1>来一场说走就走的旅行</h1>Let's go on a trip: startup date [October Monday 03 10:23:29
							</div>
						</div>
						<div class="item">
                        ...
                        <div class="item">
                            <img src="static/assets/img/test/tree.png" alt="fourth slide">
                            <div class="carousel-caption"><h1>来一场说走就走的旅行</h1>Let's go on a trip: startup date [October Monday 03 10:23:29
                            </div>
                        </div>
					</div>
						...
						<div class="col-sm-6 col-md-4 col-lg-5">
							<div class="thumbnail"  style="height: 450px;">
								<a href="hotel/content?hid=${hotel.hid}">
										<%--<img src="${viewPoint.tpVpic}" alt="..." class="img-rounded">--%>
									<img class="img-rounded" src="${hotel.imgUrl}" alt="...">
								</a>
								<div class="caption">
									<h3>${hotel.title}</h3>
									<ol>
