					...
					<form class="form-horizontal" action="admin/useredithandle" method="post">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="email" name="uemail" class="form-control" id="inputEmail" value="${user.uemail}" placeholder="${user.uemail}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="password" name="upwd" class="form-control" id="inputPwd" value="${user.upwd}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="age" class="form-control" id="inputAge" value="${user.age}" placeholder="${user.age}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="gender" class="form-control" id="inputGender" value="${user.gender}" placeholder="${user.gender}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="phone" class="form-control" id="inputPhone" value="${user.phone}" placeholder="${user.phone}">
								</div>
							</div>
