						...
						<form class="form-horizontal" action="admin/viewedithandle" method="post">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="tpTitle" class="form-control" id="tpTitle" value="${viewPoint.tpTitle}" placeholder="${viewPoint.tpTitle}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="tpVname" class="form-control" id="tpVname" value="${viewPoint.tpVname}" placeholder="${viewPoint.tpVname}">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="tpVtype" class="form-control" id="tpVtype" value="${viewPoint.tpVtype}" placeholder="${viewPoint.tpVtype}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="tpVphone" class="form-control" id="tpVphone" value="${viewPoint.tpVphone}" placeholder="${viewPoint.tpVphone}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="tpLevel" class="form-control" id="tpLevel" value="${viewPoint.tpLevel}" placeholder="${viewPoint.tpLevel}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="tpPrice" class="form-control" id="tpPrice" value="${viewPoint.tpPrice}" placeholder="${viewPoint.tpPrice}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="tpZip" class="form-control" id="tpZip" value="${viewPoint.tpZip}" placeholder="${viewPoint.tpZip}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="tpOpentime" class="form-control" id="tpOpentime" value="${viewPoint.tpOpentime}" placeholder="${viewPoint.tpOpentime}">
									</div>
								</div>
